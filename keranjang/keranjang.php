...
<head>
    ...
    <title>keranjang | warmingUP</title>
</head>
            ...
            <article class=" mx-10 w-full">
                ...
                <div class="shadow-md rounded-md border-2 border-slate-300">
                    <div class="m-3  flex items-center ">
                        <div class="w-full flex items-center my-3">
                            ...
                            <img src="../assets/img/makanan/siomay.jpg" alt="keranjang-makanan" class="w-[68px] h-[68px] rounded-xl mx-5">
                ...
                <div class="shadow-md rounded-md border-2 border-slate-300">
                    <div class="m-3  flex items-center ">
                        <div class="w-full flex items-center my-3">
                            <input type="checkbox" name="keranjang-makanan" id="jumlah-makanan" class="w-5 h-7 mx-3">
                            <img src="../assets/img/nasgor/nasigorengtelur.jpg" alt="keranjang-makanan" class="w-[68px] h-[68px] rounded-xl mx-5">
                ...
                <div class="shadow-md rounded-md border-2 border-slate-300">
                    <div class="m-3  flex items-center ">
                        <div class="w-full flex items-center my-3">
                            <input type="checkbox" name="keranjang-makanan" id="jumlah-makanan" class="w-5 h-7 mx-3">
                            <img src="../assets/img/minuman/kopisusuaren.jpg" alt="keranjang-makanan" class="w-[68px] h-[68px] rounded-xl mx-5">
