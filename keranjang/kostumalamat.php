                        ...
                        <div class="max-w-4xl mx-3 m-6">
                            ...
                            <div class="flex justify-center my-3">
                                <a href="transaksi.php">
                                    <button type="button" class="bg-blue-500 p-3 px-10 text-xl font-semibold text-white rounded-xl shadow-lg hover:bg-blue-800">Simpan</button>
                                </a>
                            </div>
                        </div>
                    </form>
