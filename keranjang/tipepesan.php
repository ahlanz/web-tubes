...
<head>
    ...
    <title>tipe pesan | warmingUP</title>
</head>
                        ...
                        <ul>
                            <li>
                                <div class="border-b-2 border-slate-300 flex items-center p-3">
                                    <img src="../assets/img/icon/pesanantar.jpg" alt="gambar cash" class=" w-9 h-9 rounded-full">
                            ...
                            <li>
                                <div class="border-b-2 border-slate-300 flex items-center p-3">
                                    <img src="../assets/img/icon/takeaway.jpg" alt="gambar cash" class=" w-9 h-9 rounded-full">
                            ...
                            <li>
                                <div class=" flex items-center p-3">
                                    <img src="../assets/img/icon/makanditempat.jpg" alt="gambar cash" class=" w-9 h-9 rounded-full">
