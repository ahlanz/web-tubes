...
<head>
    ...
    <title>detail transaksi | warmingUP</title>
</head>
        ...
        <section class="max-w-6xl mx-auto">
            <article>
                ...
                <div class="max-w-xl my-10 mx-auto rounded-lg border-2 border-slate-300 shadow-md">
                    ...
                    <div class="p-4 flex justify-between border-b-2 border-slate-300">
                        ...
                        <div class="flex">
                            <a href="#" class=" mx-3">
                                <img src="../assets/img/icon/qris.jpg" alt="logo-pembayaran" class="w-8  rounded-full object-cover">
                            </a>
            ...
            <article>
                <div class="w-full flex justify-center">
                    <a href="invoice.php" class="bg-blue-500 rounded-lg shadow-lg hover:shadow-xl hover:bg-blue-800">
