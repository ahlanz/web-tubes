          ...
          <div id="carouselExampleCaptions" class="carousel slide relative" data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden">
              <div class="carousel-item active relative float-left w-full h-[500px]">
                <img src="./assets/img/banner1.jpg" class="block w-full object-cover" alt="..." />
              </div>
              <div class="carousel-item relative float-left w-full h-[500px]">
                <img src="./assets/img/banner2.jpg" class="block w-full object-cover" alt="..." />
              </div>
              <div class="carousel-item relative float-left w-full h-[500px]">
                <img src="./assets/img/banner3.jpg" class="block w-full object-cover" alt="..." />
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class="grid grid-cols-4 gap-5">
                <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                  <div class="relative">
                    <a href="#">
                      <img src="./assets/img/warmindo/indomietektek.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                ...
                <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                  <div class="relative">
                    <a href="#">
                      <img src="./assets/img/nasgor/nasigorengtelur.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                      <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                        <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                      </div>
                    </a>
                ...
                <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                  <div class="relative">
                    <a href="#">
                      <img src="./assets/img/camilan/kebab.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                      <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                        <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                      </div>
                    </a>
                ...
                <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
                  <div class="relative">
                    <a href="#">
                      <img src="./assets/img/bento/bento3.JPG" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                      <div class="w-1/2 h-auto bg-red-500 absolute mx-2 my-2 top-0 left-0 rounded-full">
                        <p class="font-semibold text-white p-1 items-center text-center">20% off</p>
                      </div>
                    </a>
        ...
        <div class="flex justify-center">
          <div class="grid grid-cols-4 gap-5">
            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
              <div class="relative">
                <a href="#">
                  <img src="./assets/img/makanan/siomay.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                </a>
              </div>
              <div>
              </div>
            ...
            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
              <div class="relative">
                <a href="#">
                  <img src="./assets/img/nasgor/nasgorteri.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                </a>
              </div>
              <div>
              </div>
            ...
            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
              <div class="relative">
                <a href="#">
                  <img src="./assets/img/bento/bentospecialchicken.JPG" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                </a>
              </div>
              <div>
              </div>
            ...
            <div class="w-200 h-300 bg-white rounded-lg border border-gray-200 shadow-md">
              <div class="relative">
                <a href="#">
                  <img src="./assets/img/minuman/mojito.jpg" alt="card-food" class="rounded-t-lg h-[135px] w-full object-cover">
                </a>
              </div>
              <div>
              </div>
