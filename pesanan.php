...
<html lang="en">
  <head>
    ...
    <title>Data pesanan | WarmingUp</title>
  </head>
  <body>
  <!-- Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>WarmingUp</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="pesanan.php"><i class="fa-solid fa-cart-shopping"></i></a>
            </li>
            <li class="nav-item">
